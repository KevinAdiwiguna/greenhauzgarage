			...
			<div className="relative max-w-6xl mx-auto px-6 w-full space-y-10 text-center md:text-left z-10">
				...
				<div className="space-y-4">
					<h1 className="text-6xl md:text-8xl font-black uppercase tracking-tighter leading-none text-white">
						GREENHAUZ<span className="text-accent">GARAGE</span>
					</h1>
					<h2 className="text-xl md:text-3xl font-black tracking-wide text-foreground uppercase">
						Di mana Rumah & Garasi Bertemu.
					</h2>
					<p className="text-muted text-base md:text-lg max-w-3xl leading-relaxed font-medium">
						Kami menghadirkan standar baru restorasi, pengecatan, kustomisasi bodi, dan penyetelan performa mesin di Lombok. Dikerjakan dengan keahlian presisi tinggi, material premium, dan suasana bengkel yang bersahabat untuk mendiskusikan visi kendaraan impian Anda.
					</p>
				</div>
				...
				<div className="flex flex-wrap justify-center md:justify-start gap-4">
					<Link
						href="#services"
						className="bg-accent text-accent-foreground hover:bg-accent/90 transition-all font-black tracking-widest px-8 py-4 text-sm uppercase border border-accent transform -skew-x-12 active:scale-95 duration-100"
					>
						LIHAT LAYANAN KAMI
					</Link>
					<Link
						href="#catalog"
						className="bg-transparent text-white hover:bg-white/5 transition-all font-black tracking-widest px-8 py-4 text-sm uppercase border border-border hover:border-white transform -skew-x-12 active:scale-95 duration-100"
					>
						KATALOG JUAL-BELI
					</Link>
				</div>
